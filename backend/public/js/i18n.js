(function(){
  ...
  var TRANSLATIONS = {
    it: {
      ...
      // ---- Guscio AUROR: navigazione, account, progetti ----
      'nav.aria': 'Navigazione',
      'nav.menu': 'Menu',
      'nav.projects': 'Progetti',
      'section.importCad': 'Importa CAD',
      'import.choose': 'Scegli un file…',
      'import.units': 'Unità del file',
      'import.units.auto': 'Come dichiarate nel file',
      'import.units.mm': 'Millimetri',
      'import.units.cm': 'Centimetri',
      'import.units.m': 'Metri',
      'import.units.in': 'Pollici',
      'import.units.ft': 'Piedi',
      'import.units.help': 'Serve quando il file non le dichiara: senza, si assumono millimetri.',
      'import.extent': 'Ingombro',
      'import.width': 'Larghezza (mm)',
      'import.height': 'Altezza (mm)',
      'import.size.help': 'Scrivi la misura che conosci: l\'altra segue mantenendo le proporzioni. Le dimensioni hanno la precedenza sulle unità.',
      'import.again': 'Rifai l\'importazione',
      'import.again.stale': 'Il disegno è cambiato dopo l\'importazione: annulla a mano e reimporta il file.',
      'import.empty': 'Il file è stato letto ma non conteneva geometria importabile.',
      'import.toast': 'oggetti importati',
      'import.hint': 'Si può anche trascinare un file sulla tela. Il disegno importato si aggiunge a quello aperto e si annulla con Undo.',
      'import.hint.full': 'DXF letto qui; DWG convertito sul server con ',
      'import.hint.dxfOnly': 'Solo DXF: nessun convertitore DWG disponibile in questa installazione.',
      'nav.save': 'Salva',
      'nav.saveAs': 'Salva come…',
      'nav.admin': 'Amministrazione',
      'header.theme.title': 'Tema chiaro / scuro / e-ink',
      ...
      'account.logout': 'Esci',
      'account.source.local': 'Account locale',
      'account.source.ldap': 'Account della directory LDAP',
      'password.title': 'Cambia la password',
      'password.intro': 'La password iniziale va cambiata prima di usare l\'applicazione.',
      'password.current': 'Password attuale',
      'password.next': 'Nuova password (almeno 8 caratteri)',
      'password.repeat': 'Ripeti la nuova password',
      'password.tooShort': 'La nuova password deve avere almeno 8 caratteri',
      'password.mismatch': 'Le due password non coincidono',
      'password.changed': 'Password aggiornata',
      'project.none': 'Nessun progetto',
      'project.modal.title': 'Progetti',
      'project.modal.empty': 'Nessun progetto salvato sul server.',
      'project.modal.new': 'Nuovo',
      'project.modal.export': 'Esporta tutti',
      'project.modal.import': 'Importa',
      'project.saveAs.title': 'Salva progetto come',
      'project.saveAs.name': 'Nome del progetto',
      'project.delete': 'Elimina progetto',
      'project.deleteConfirm': 'Eliminare definitivamente questo progetto?',
      'project.state.dirty': 'modifiche non salvate',
      'project.state.saving': 'salvataggio…',
      'project.state.saved': 'salvato',
      'project.toast.saved': 'Progetto salvato',
      'project.toast.created': 'Progetto creato',
      'project.toast.opened': 'Progetto aperto',
      'project.toast.deleted': 'Progetto eliminato',
      'project.toast.imported': 'Progetti importati',
      'header.user': 'Utente',
    ...
    en: {
      ...
      // ---- AUROR shell: navigation, account, projects ----
      'nav.aria': 'Navigation',
      'nav.menu': 'Menu',
      'nav.projects': 'Projects',
      'section.importCad': 'Import CAD',
      'import.choose': 'Choose a file…',
      'import.units': 'Units of the file',
      'import.units.auto': 'As declared in the file',
      'import.units.mm': 'Millimetres',
      'import.units.cm': 'Centimetres',
      'import.units.m': 'Metres',
      'import.units.in': 'Inches',
      'import.units.ft': 'Feet',
      'import.units.help': 'Needed when the file does not declare them: without, millimetres are assumed.',
      'import.extent': 'Extent',
      'import.width': 'Width (mm)',
      'import.height': 'Height (mm)',
      'import.size.help': 'Type the measure you know: the other follows, keeping the proportions. Sizes take precedence over units.',
      'import.again': 'Redo the import',
      'import.again.stale': 'The drawing changed after the import: undo by hand and import the file again.',
      'import.empty': 'The file was read but held no geometry that can be imported.',
      'import.toast': 'objects imported',
      'import.hint': 'You can also drop a file onto the canvas. What you import is added to the open drawing and can be undone.',
      'import.hint.full': 'DXF is read here; DWG is converted on the server with ',
      'import.hint.dxfOnly': 'DXF only: no DWG converter available in this installation.',
      'nav.save': 'Save',
      'nav.saveAs': 'Save as…',
      'nav.admin': 'Administration',
      'header.theme.title': 'Light / dark / e-ink theme',
      'header.account.title': 'Account',
      'action.close': 'Close',
      'action.save': 'Save',
      'account.title': 'Account',
      ...
      'account.source.local': 'Local account',
      'account.source.ldap': 'LDAP directory account',
      'password.title': 'Change your password',
      'password.intro': 'The initial password must be changed before using the application.',
      'password.current': 'Current password',
      'password.next': 'New password (at least 8 characters)',
      'password.repeat': 'Repeat the new password',
      'password.tooShort': 'The new password must be at least 8 characters',
      'password.mismatch': 'The two passwords do not match',
      'password.changed': 'Password updated',
      'project.none': 'No project',
      'project.modal.title': 'Projects',
      'project.modal.empty': 'No project saved on the server.',
      'project.modal.new': 'New',
      'project.modal.export': 'Export all',
      'project.modal.import': 'Import',
      'project.saveAs.title': 'Save project as',
      'project.saveAs.name': 'Project name',
      'project.delete': 'Delete project',
      'project.deleteConfirm': 'Permanently delete this project?',
      'project.state.dirty': 'unsaved changes',
      'project.state.saving': 'saving…',
      'project.state.saved': 'saved',
      'project.toast.saved': 'Project saved',
      'project.toast.created': 'Project created',
      'project.toast.opened': 'Project opened',
      'project.toast.deleted': 'Project deleted',
      'project.toast.imported': 'Projects imported',
      'header.user': 'User',
